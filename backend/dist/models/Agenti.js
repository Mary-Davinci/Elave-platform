...
// Agente schema
const AgenteSchema = new mongoose_1.Schema({
    businessName: {
        type: String,
...
AgenteSchema.statics.findByUser = function (userId) {
    return this.find({ user: userId }).sort({ createdAt: -1 });
};
AgenteSchema.statics.findByVatNumber = function (vatNumber, userId) {
...
AgenteSchema.post('save', function (error, doc, next) {
...
const Agente = mongoose_1.default.model('Agente', AgenteSchema);
exports.default = Agente;
//# sourceMappingURL=Agenti.js.map