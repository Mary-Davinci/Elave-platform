...
export class NotificationService {
  static async notifyAdminsOfPendingApproval(data: NotificationData): Promise<void> {
    try {
      ...
      const notification = new Notification({
        ...
        recipients: adminUsers.map((user: any) => user._id),
        readBy: [] 
      });
  ...
  static async getNotificationsForUser(userId: string): Promise<any[]> {
    try {
