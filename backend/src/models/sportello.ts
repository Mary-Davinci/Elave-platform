...
SportelloLavoroSchema.statics.findByUser = function(userId: string) {
  return this.find({ user: userId }).sort({ createdAt: -1 });
};

SportelloLavoroSchema.statics.findByVatNumber = function(vatNumber: string, userId?: string) {
...
SportelloLavoroSchema.post('save', function(error: any, doc: any, next: any) {
...
const SportelloLavoro = mongoose.model<ISportelloLavoroDocument>('SportelloLavoro', SportelloLavoroSchema);
